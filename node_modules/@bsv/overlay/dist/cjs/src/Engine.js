...
class Engine {
    ...
    async submit(taggedBEEF, onSteakReady, mode = 'current-tx') {
        ...
        if (relevantTopics.length > 0) {
            ...
            const domainToTopicsMap = new Map();
                ...
                try {
                    ...
                    if (lookupAnswer.type === 'output-list') {
                        ...
                        if (shipAdvertisements.length > 0) {
                            shipAdvertisements.forEach((advertisement) => {
                                var _a;
                                if (!domainToTopicsMap.has(advertisement.domain)) {
                                    domainToTopicsMap.set(advertisement.domain, new Set());
                                }
                                (_a = domainToTopicsMap.get(advertisement.domain)) === null || _a === void 0 ? void 0 : _a.add(topic);
                            });
                        }
                    }
                }
            ...
            if (this.shipTrackers !== undefined && this.shipTrackers.length !== 0 && relevantTopics.includes('tm_ship')) {
                this.shipTrackers.forEach(tracker => {
                    ...
                    if (domainToTopicsMap.get(tracker) !== undefined) {
                        (_a = domainToTopicsMap.get(tracker)) === null || _a === void 0 ? void 0 : _a.add('tm_ship');
                    }
                    else {
            ...
            if (this.slapTrackers !== undefined && this.slapTrackers.length !== 0 && relevantTopics.includes('tm_slap')) {
                this.slapTrackers.forEach(tracker => {
                    var _a;
                    if (domainToTopicsMap.get(tracker) !== undefined) {
                        (_a = domainToTopicsMap.get(tracker)) === null || _a === void 0 ? void 0 : _a.add('tm_slap');
                    }
                    else {
                        domainToTopicsMap.set(tracker, new Set(['tm_slap']));
                    }
                });
            }
